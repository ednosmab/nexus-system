...
export default function WhyShiten() {
  return (
    <div className="flex flex-col gap-8">
      <section className="flex flex-col gap-3">
        <h1 className="text-2xl font-bold text-text-primary">Why does Shiten exist?</h1>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="layer-card flex flex-col gap-2">
            <h3 className="text-sm font-medium text-danger">Without Shiten</h3>
          ...
          <div className="layer-card flex flex-col gap-2">
            <h3 className="text-sm font-medium text-neon">With Shiten</h3>
            <ul className="text-sm text-text-secondary flex flex-col gap-1">
      ...
      <section className="layer-card flex flex-col gap-3">
        ...
        <p className="text-sm text-text-secondary">
          Shiten detects your project's context, generates a maturity profile, and provides tools to keep engineering healthy over time.
        </p>
