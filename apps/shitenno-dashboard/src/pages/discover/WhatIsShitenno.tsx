...
export default function WhatIsShitenno() {
  return (
    <div className="flex flex-col gap-8">
      <section className="layer-hero">
        <Logo size="lg" />
        <h1 className="text-2xl font-bold text-text-primary">What is Shugo?</h1>
        <p className="text-text-secondary max-w-xl">
          Shugo is a CLI that gives persistent context about your project to you and AI agents, so no one starts each session from zero.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-4">
        ...
        <div className="layer-card flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <code className="text-accent font-mono text-sm font-bold">shugo init</code>
...
✔ Project analysis complete
  ...
  Detected:
    ...
    CI/CD:     yes`}</pre>
        ...
        <div className="layer-card flex flex-col gap-2">
          <div className="flex items-center gap-2">
            <code className="text-accent font-mono text-sm font-bold">shugo status</code>
