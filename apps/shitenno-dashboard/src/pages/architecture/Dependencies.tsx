...
const dependencies = [
  { from: 'shitenno-cli', to: 'context_buffer.yaml', type: 'read/write' },
  { from: 'shitenno-cli', to: 'maturity-profile.json', type: 'read' },
  { from: 'shitenno-cli', to: 'engineering-state/', type: 'read/write' },
  { from: 'shitenno-cli', to: 'telemetry/', type: 'write' },
  { from: 'shitenno-cli', to: 'governance/agents/', type: 'read' },
