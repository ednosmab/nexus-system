...
| Plano | Resumo |
|---|---|
| [plano-correcao-shiten-audit](2026-07-09-plano-correcao-shiten-audit.md) | Correções do shiten audit (5 bugs) |

### 2026-07-09
| Plano | Resumo |
|---|---|
| [shiten-single-source-of-truth](done/shiten-single-source-of-truth-plan.md) | Engineering State como SSOT — 5 bugs corrigidos, accessor + ESLint guard |
...
| Plano | Resumo |
|---|---|
| [plano-correcao-shiten](done/2026-07-06-plano-correcao-shiten.md) | Correções gerais do sistema |
...
| [expand-shiten-audit](done/2026-07-04-expand-shiten-audit.md) | Expansão do audit coverage |
...
| [briefing-onboarding-shiten](done/briefing-onboarding-shiten.md) | Briefing de onboarding |
| [plano-correcao-shiten-audit](done/plano-correcao-shiten-audit.md) | Correção do shiten audit |
...
- **A4** — Git hooks (`shiten hooks --install`)
- **A7** — Skill template (`shiten skill:create`) — **DESCARTADO**

### P2 — Médio prazo (≤ 90d)
- **2.1** — `shiten detect --approve/--reject` ✅ **CONCLUÍDO**
- **2.3b** — `shiten bench --compare` ✅ **CONCLUÍDO**
- **2.4** — `shiten feedback --list` ✅ **CONCLUÍDO**
