...
| Comando | Função |
|---|---|
| `shiten init` | Instala capacidades seleccionadas |
| `shiten upgrade --capability <name>` | Adiciona uma capacidade |
| `shiten assess` | Mostra capacidades recomendadas |
| `shiten doctor` | Verifica estado das capacidades |
| `shiten status` | Mostra estado geral do sistema |
