...
2. **Tight coupling to file layout** — Commands depended on internal file paths (`shitenno-go/maturity-profile.json`, `shitenno-go/knowledge-debt.json`), making it fragile to reorganize the state layer.
...
- `shiten-single-source-of-truth-plan.md` — Original policy definition
