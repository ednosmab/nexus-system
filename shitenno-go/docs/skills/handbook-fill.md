...
<!-- PHILOSOPHY -->
## Visão
O Shiten é um framework de governança...
...
## 🔗 Referências
- `shitenno-go/governance/rules/RULE-HB-001.json` — Regra de activação
- `docs/handbook/*.template.md` — Templates a preencher
- `src/commands/handbook.ts` — Command CLI
- `shitenno-go/docs/skills/quick-board-enforcement.md` — Quick Board
