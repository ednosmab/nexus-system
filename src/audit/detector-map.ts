...
export function buildDetectorMap(
  ...
  return {
    ...
    detectMissingDocs: () => detectMissingDocs(shitenDir),
    detectOrphanDirs: () => detectOrphanDirs(shitenDir),
    detectStaleBuffer: () => detectStaleBuffer(shitenDir),
    detectDatePlaceholders: () => detectDatePlaceholders(shitenDir),
    detectEmptyDirs: () => detectEmptyDirs(shitenDir),
    detectBrokenRefs: () => detectBrokenRefs(shitenDir),
    detectBrokenDirRefs: () => detectBrokenDirRefs(shitenDir),
    detectNonBacktickFileRefs: () => detectNonBacktickFileRefs(shitenDir),
    detectMissingGitignore: () => detectMissingGitignore(shitenDir),
    detectMaturityInconsistency: () => detectMaturityInconsistency(shitenDir),
    detectAdrCoverage: () => detectAdrCoverage(shitenDir),
    detectMissingPackageJson: () => detectMissingPackageJson(shitenDir),
    detectUnreferencedDirs: () => detectUnreferencedDirs(shitenDir),
    detectReportNaming: () => detectReportNaming(shitenDir),
    detectBareWordRefs: () => detectBareWordRefs(shitenDir),
    detectTemplateDirRefs: () => detectTemplateDirRefs(shitenDir),
    detectExtensionMismatch: () => detectExtensionMismatch(shitenDir),
    detectSystemMapMismatch: () => detectSystemMapMismatch(shitenDir),
    detectBrokenCommands: () => detectBrokenCommands(shitenDir),
    detectP0Inconsistency: () => detectP0Inconsistency(shitenDir),
    detectTripleMaturityScore: () => detectTripleMaturityScore(shitenDir),
    detectEmptyStack: () => detectEmptyStack(shitenDir),
    detectScriptWiring: () => detectScriptWiring(projectRoot, shitenDir),
    detectAgentContractRefs: () => detectAgentContractRefs(shitenDir),
    detectBufferSchemaMismatch: () => detectBufferSchemaMismatch(shitenDir),
    detectRuleTypo: () => detectRuleTypo(shitenDir),
    detectNumberingGap: () => detectNumberingGap(shitenDir),
    detectDocCountMismatch: () => detectDocCountMismatch(shitenDir),
    ...
    detectIncompleteSessionClose: () => detectIncompleteSessionClose(shitenDir),
    detectMissingFeedback: () => detectMissingFeedback(shitenDir),
    detectInvalidBacklogStates: () => detectInvalidBacklogStates(shitenDir),
    detectPlanFormat: () => detectPlanFormat(shitenDir),
    detectRuleExecutionCompliance: () => detectRuleExecutionCompliance(shitenDir),
