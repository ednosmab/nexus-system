  ...
  return [
    ...
    },
    {
      ...
      actions: [
        ...
        { type: "create_reminder", params: { message: "Multiple validation failures detected — run 'shugo audit'" } },
      ],
      priority: 2,
      dependencies: [],
      enabled: true,
    ...
    },
    {
      ...
      actions: [
        { type: "update_quick_board", params: { item: "Run 'shugo upgrade --accept-recommended'", section: "proximo" } },
      ],
      priority: 3,
      dependencies: [],
      enabled: true,
    ...
    },
    {
      ...
      actions: [
        { type: "create_reminder", params: { message: "Health score is below 50 — run 'shugo audit' to improve" } },
      ],
      priority: 2,
      dependencies: [],
      enabled: true,
    ...
    },
    {
      ...
      actions: [
        { type: "run_shugo_command", params: { command: "validate" } },
    ...
    },
    {
      ...
      conditions: [],
      actions: [
        { type: "log_event", params: { event: "session_end_plans", message: "Session ended — run 'shugo plan md lifecycle' to archive active plans" } },
      ],
      priority: 3,
      dependencies: [],
      enabled: true,
    ...
    },
    {
      ...
      conditions: [],
      actions: [
        { type: "log_event", params: { event: "plan_created", message: "New plan detected — run 'shugo plan prepare <planId>' to format header, extract checklist, and sync backlog" } },
        { type: "create_reminder", params: { message: "New plan detected — run 'shugo plan prepare' to prepare it", priority: "medium", category: "plan" } },
      ],
      priority: 1,
      dependencies: [],
      enabled: true,
