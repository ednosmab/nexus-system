 ...
 *
 * Usage: node dist/nexus-system/scripts/generate-changelog.js [--since <date>] [--output <path>]
 */
...
const entries = logLines.map(parseCommit).filter((e): e is ChangelogEntry => e !== null);
