/**
 * PROJECT PROFILE — Configuração específica do projecto para o Shitenno-go.
 *
 * Este ficheiro é gerado automaticamente pelo `shiten init`.
...
export const profile: ProjectProfile = {
  ...
  areas: [
    // Detectadas automaticamente pelo shiten init
  ...
  // forbiddenOperationsPath: "shitenno-go/docs/FORBIDDEN_OPERATIONS.md",

  /** Caminho para handoffs. */
  // handoffsPath: "shitenno-go/governance/handoffs",

  /** Score a partir do qual PREMORTEM é obrigatório. */
  // highComplexityThreshold: 7,

  /** Caminho para SDRs. */
  // sdrPath: "shitenno-go/docs/sdr",
