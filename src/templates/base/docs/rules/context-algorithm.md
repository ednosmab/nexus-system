...
- **Registre no buffer quais documentos foram lidos** na seção `## Documentos Carregados via MCP`.
...
- Escreva o erro detalhado na seção `## Impedimentos & Logs de Erro Recentes` do buffer.
