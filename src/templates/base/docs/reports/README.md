...
Estes relatórios são o dado de entrada de qualquer fase futura do Shugo que dependa de observar evolução no tempo (ex: "esta área está ficando mais ou menos complexa ao longo das sessões"). Apagar ou não versionar isso destrói a única coisa que torna o sistema capaz de aprender com sua própria história.
