 ...
 *
 * Executes shiten CLI commands via child_process and manages
...
export const COMMAND_DEFINITIONS: CommandDefinition[] = [
  ...
  },
  {
    ...
    args: ["sync", "--json"],
    label: "shiten sync",
    description: "Sync governance files from shitenno-go",
    estimatedTime: "<2s",
    category: "destructive",
    requiresConfirmation: true,
  },
