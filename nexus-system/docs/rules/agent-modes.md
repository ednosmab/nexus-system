...
e. **Path canónico:** Planos com ≥ 5 steps ou ≥ 2 ficheiros afectados são arquivados em `docs/plans/YYYY-MM-DD-<slug>.md` usando o template em `src/templates/base/docs/plans/TEMPLATE.md`. O ficheiro contém checkboxes que o build vai preenchendo.
